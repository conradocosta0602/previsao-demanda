...
- V56: Sinalizacao persistente de ajuste manual - celulas com ajuste_manual ficam amarelas permanentemente na Tela de Demanda (ao carregar, nao apenas na sessao); badge "Ajuste Manual" amarelo na Tela de Pedido ao Fornecedor (ambas visualizacoes); Salvar Demanda so marca ajuste_manual quando valor e diferente do demanda_prevista (evita falsos positivos)
...
- V56: Sinalizacao persistente de ajuste manual - celulas com ajuste_manual ficam amarelas permanentemente na Tela de Demanda (nao apenas na sessao); badge amarelo na Tela de Pedido; Salvar Demanda so marca ajuste_manual quando valor difere do demanda_prevista (evita falsos positivos em todos os itens do fornecedor); limpeza de 5530 registros com ajustes falsos (v6.33)
